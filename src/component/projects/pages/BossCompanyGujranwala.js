...
const BossCompanyGujranwala = () => {
  ...
  useEffect(() => {
    ...
    const params = {
      ...
      Prefix: '16-BOOS-COMPANY-GUTRANWALA/', // folder path inside the bucket (if any)
    };
        ...
        <div className="bg-white mt-20">
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-10">
            <h2 className="mb-4 text-4xl text-center text-gray-900 font-themeFont">
              BOOS COMPANY GUJRANWALA
            </h2>
            <h1 className="mb-4 font-themeFont">
              Number of BOOS COMPANY GUJRANWALA Images{" "}
              {images?.length}
            </h1>
...
export default BossCompanyGujranwala