...
import { TwoKanalProjectData } from '../../../../db/kitchen-db';
...
const Twokanal = () => {
  ...
  const filteredData = TwoKanalProjectData.filter((card) =>
    ...
    <div className="bg-white mt-10">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-10">
        ...
        <h1 className="mb-2 font-themeFont">
          Number of 2-Kanal House Kitchen Projects {TwoKanalProjectData.length}
        </h1>
