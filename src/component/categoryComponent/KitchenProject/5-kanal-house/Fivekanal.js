...
import { FiveKanalProjectData } from '../../../../db/kitchen-db';
...
const Fivekanal = () => {
  ...
  const filteredData = FiveKanalProjectData.filter((card) =>
    ...
    <div className="bg-white mt-10">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-10">
        ...
        <h1 className="mb-2 font-themeFont">
          Number of 5-Kanal House Kitchen Projects {FiveKanalProjectData?.length}
        </h1>
